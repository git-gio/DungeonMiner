...
public class Container : MonoBehaviour
{
    ...
    // Dictionary because it means I have to iterate less over empty stuff and less storage
    ...
    // initialise voxel with material and position
    public void Initialise(Material mat, Vector3 position)
    {
        ConfigureComponents();
